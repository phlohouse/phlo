...
export function Console({
  ...
  return (
    <div className="bg-canvas h-svh p-2">
      <div className="border-rule bg-panel flex h-full flex-col overflow-hidden rounded-xl border shadow-md">
        <header className="border-rule bg-raised flex h-[33px] flex-none items-center gap-3 border-b px-3">
        ...
        <div className="relative flex min-h-0 flex-1">
          <aside className="border-rule bg-raised hidden w-56 flex-none border-r sm:block">
