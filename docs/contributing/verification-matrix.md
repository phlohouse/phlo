...
| Phlo agent app | From `apps/phlo-agent`: `npm test`, `npm run typecheck`, and `npm run build` | Exercise the affected Eve, GitHub, browser, or deployment boundary; run `npm audit --audit-level=high` for dependency changes |
