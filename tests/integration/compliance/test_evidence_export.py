...
class TestEvidenceExport:
    ...
    def test_cli_export_evidence_command(self, monkeypatch) -> None:
    ...
    def test_cli_verify_evidence_command(self, monkeypatch) -> None:
    ...
    def test_evidence_pack_signature_modified_evidence(self) -> None:
    ...
    def test_evidence_pack_signature_modified_manifest(self) -> None:
    ...
    def test_evidence_pack_signature_recomputed_checksums_attack(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            tampered_records = json.dumps(
                {"event": "fabricated", "seq": 999}, sort_keys=True
            ).encode()
            ...
            rebuilt = Path(tmpdir) / "attacked.zip"
    ...
    def test_evidence_pack_signature_missing(self) -> None:
    ...
    def test_evidence_pack_signature_changed(self) -> None:
    ...
    def test_evidence_pack_export_no_key_fails_closed(self, monkeypatch) -> None:
    ...
    def test_evidence_pack_verify_no_key_fails_closed(self, monkeypatch) -> None:
    ...
    def test_evidence_pack_signature_no_secret_exposure(self) -> None:
