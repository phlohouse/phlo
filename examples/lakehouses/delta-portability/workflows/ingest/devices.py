"""DLT ingestion of the device registry database into Delta.
...
def registry_db() -> Path:
    """Return the registry database path (override with DELTA_REGISTRY_DB)."""
    return Path(os.environ.get("DELTA_REGISTRY_DB", DEFAULT_REGISTRY_DB))
